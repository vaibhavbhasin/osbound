$(document).ready(function () {
    //  vertical-nav-type="expanded" vertical-effect="push" vnavigation-view="view1" fream-type="theme1" sidebar-img="false" sidebar-img-type="img1" layout-type="light" logo-theme="theme2"
    $("#pcoded").pcodedmenu({
