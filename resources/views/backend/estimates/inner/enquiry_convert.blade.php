    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-right">
                <a href="{{route($baseRoute.'.edit',$enquiry->id)}}" class="btn btn-sm btn-info active" type="button" id="saveEstimateBtn">Back To Enquiry</a>
                <button class="btn btn-sm btn-primary active" type="button" id="saveEstimateBtn">Save Estimate</button>
            </div>
        </div>
        <div class="card-block">
            {!! Form::model($oldData, ['route' => ['estimates.update', $oldData->id], 'method' => 'post','files' => true,'id'=>'estimateForm','autocomplete'=>'off']) !!}
            @method('PATCH')
            <div class="row">
                <div class="col-md-4">
                    <div class="form-row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="copy_address">
                        ...
                        <input type="checkbox" id="copy_address" data-route="{{route('estimates.copyAddress',$oldData->id)}}">
                      </div>
