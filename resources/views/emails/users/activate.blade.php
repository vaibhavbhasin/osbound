...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;box-shadow: 0px 0px 10px #b4b4b4;border-radius: 10px;position: relative;overflow: hidden;" class="content">
  ...
  <tr>
    <td align="center" bgcolor="#fff" style="padding: 30px 20px 10px; color: #000; font-family: Arial, sans-serif; font-size: 20px; line-height: 1.4;">
      <p style="margin: 0;">
        <b style="font-size: 28px;font-weight: normal;">Your account has been activated successfully. You can now login.</b>
      </p>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td align="center" width="100%" style="color: #000; font-family: Arial, sans-serif; font-size: 12px;">
            2019 &copy;
            <a href="{{ config('app.url') }}" style="color: #0073AA;">{{ config('app.name') }}</a> | All Rights Reserved.
          </td>
        </tr>
      </table>
    </td>
