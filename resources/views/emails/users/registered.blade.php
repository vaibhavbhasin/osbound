...
<body style="margin: 10px 0; padding: 20px;background: #eef1f3;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;box-shadow: 0px 0px 10px #b4b4b4;border-radius: 10px;position: relative;overflow: hidden;" class="content">
        ...
        <tr>
            <td align="center" bgcolor="#fff" style="padding: 30px 20px 10px; color: #000; font-family: Arial, sans-serif; font-size: 20px; line-height: 1.4;">
                <p style="margin: 0;"><b style="font-size: 28px;font-weight: normal;">Verify Your Account</b></p>
                <img src="<?= asset('images/verify-email.png'); ?>" alt="Wackylicious" width="200" style="display:block;margin-top: 20px;" />
            </td>
        </tr>
        <tr>
            <td align="center" bgcolor="#fff" style="padding: 10px 20px 10px; color: #000; font-family: Arial, sans-serif; font-size: 20px; line-height: 1.4;">
                <b style="font-size: 24px;font-weight: normal;">Just one more step...</b><br/>
                ...
                <table bgcolor="#0073AA" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                    <tr>
                        <td align="center" class="button">
                            <a href="#" style="color: #ffffff; text-align: center; text-decoration: none;display: inline-block;padding: 15px 20px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;">Activate Account</a>
                        </td>
                    </tr>
                </table>
            </td>
